        ...
        <section className='bg-second py-12'>
            <Container>
                ...
                <Flex className='flex-wrap gap-7'>
                    ...
                    <div className='w-[456px] h-[402px] bg-gradient-to-r from-[#FFEDD5]  to-[#FED7AA] rounded-[28px]  overflow-hidden'>
                    ...
                    <div className='w-[468px] h-[402px] rounded-[28px] bg-gradient-to-r from-[#FEF9C3] to-[#FEF08A]'>
                        <div>
                            <div className='pt-8 pl-11'><ArticleButton className='text-[#0F766E]' text='Freelance' /></div>
                            <div className='flex justify-center gap-x-2 pt-2 pb-12'>
                            ...
                            <div className=' pl-11'>
                                ...
                                <SubHeading className='w-[350px] text-[#B49467]' text='Create any collection of items. For example, a selection of red jackets or whatever you... ' extratext='read more' />
                            </div>
                        </div>
                    </div>
                    <div className='w-[700px] h-[402px] rounded-[28px] bg-gradient-to-r from-[#F3E8FF] to-[#D8B4FE]'>
                        <div>
                            <div className='pt-8 pl-11 pb-12'><ArticleButton className='text-[#0F766E]' text='Freelance' /></div>
                            <div className='flex px-11 justify-between'>
                                ...
                                <div className='flex relative'> 
                                    <div className='w-[84px] h-[84px] rounded-full absolute top-0 -left-[316px]'><Image className='w-full h-full' src={TeamThree}/></div>
                                    <div className='w-[84px] h-[84px] rounded-full absolute top-0 -left-[260px]'><Image className='w-full h-full' src={TeamFour}/></div>
                                    <div className='w-[84px] h-[84px] rounded-full absolute top-0 -left-[204px]'><Image className='w-full h-full' src={TeamFive}/></div>
                                    <div className='w-[84px] h-[84px] rounded-full absolute top-0 -left-[156px]'><Image className='w-full h-full' src={TeamSix}/></div>
                                    <div className='w-[84px] h-[84px] rounded-full absolute top-0 -left-[100px]'><Image className='w-full h-full' src={TeamSeven}/></div>
                                </div>

                            </div>
                            <div className=' pl-11'>
                                <Heading className=' pb-4.5 pt-14' text='Build a solid team' />
                                <SubHeading className='w-[350px] text-[#746FA7]' text='If there’s anything on your mind, we’d love to hear from you... ' extratext='read more' />
                            </div>
                        </div>
                    </div>
                    <div className='relative w-[1200px] h-[402px] rounded-[28px] bg-gradient-to-r from-[#FFF5FE] to-[#FBDDF7] '>
                        <div className='w-[150px] h-[150px] bg-[#DDB1E8] absolute top-0  left-1/3 blur-3xl'></div>
                         <Flex>
                            <div className='w-7/12 pl-[60px]'>
                            <Heading className=' pb-4.5 pt-[130px] ' text='Collect and Save Inspirations' />
                            <SubHeading className='pb-6 text-[#9E69AA] ' text='Find inspiration has never been easier than it is now. '  />
                            <div>
